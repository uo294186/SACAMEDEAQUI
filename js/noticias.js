...
class Noticias{
    ...
    constructor(){
        ...
        $("button").click(this.readUserInput);
    }
    ...
    readUserInput(){
        var titulo = document.querySelector("main > input:first-of-type").value;
        var entradilla = document.querySelector("main > textarea").value;
        var autor = document.querySelector("main > input:nth-of-type(2)").value;
